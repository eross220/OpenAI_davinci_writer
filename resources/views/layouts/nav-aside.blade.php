...
<aside class="app-sidebar"> 
    ...
    <ul class="side-menu app-sidebar3">
        ...
        @endrole
        <li class="side-item side-item-category mt-4">{{ __('AI Panel') }}</li>
        <li class="slide">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                ...
                <span class="side-menu__label">{{ __('My Documents') }}</span><i class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
    ...
    <div class="aside-progress-position">
        <div class="inline-flex w-100">
            <div class="flex w-100">
                <span class="fs-10 font-weight-bold pl-5"><i class="fa-solid fa-feather text-yellow mr-2"></i>{{ __('Available Words') }}: <span class="text-primary" id="available-words">{{ App\Services\HelperService::getTotalWords()}}</span> </span>
            </div>
            <div class="flex w-100 mb-4">
                <span class="fs-10 font-weight-bold pl-5"><i class="fa-solid fa-palette text-yellow mr-2"></i>{{ __('Available Images') }}: <span class="text-primary" id="available-images">{{ App\Services\HelperService::getTotalImages()}}</span> </span>
            </div>            
        </div>
    </div>
</aside>
