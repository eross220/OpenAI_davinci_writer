...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('FAQ Answers') }}</h4>
		<ol class="breadcrumb mb-2">
			<li class="breadcrumb-item"><a href="{{route('user.dashboard')}}"><i class="fa-solid fa-microchip-ai mr-2 fs-12"></i>{{ __('AI Panel') }}</a></li>
			<li class="breadcrumb-item"><a href="{{route('user.templates')}}"> {{ __('Templates') }}</a></li>
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('FAQ Answers') }}</a></li>
		</ol>
	</div>
	<div class="page-rightheader templates-scroller">
		<div id="form-group">
			<select id="template-selection" name="template-selection" data-placeholder="{{ __('Choose your template') }}" data-callback="changeTemplate">
				@foreach ($all_templates as $temp)
					<option data-id="{{ $temp->template_code }}" value="{{ $temp->slug }}" data-icon="{{   $temp->icon }}">{{ $temp->name  }}</option>
				@endforeach																																
			</select>
		</div>
	</div>
...
<form id="openai-form" class="w-100" action="" method="post" enctype="multipart/form-data">		
	@csrf
	<div class="row">	
					...
					<div class="row">
						<div class="template-view">
							...
							<div class="template-info">
								<p class="fs-12 text-muted mb-5">{{ __('Generate creative answers to questions (FAQs) about your business or website') }}</p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">	
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Language') }}</h6>								
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Product Name') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('What is the question you are generating answers for?') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Product Description') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div id="form-group">
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Creativity') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Increase or decrease the creativity level to get various results') }}"></i></h6>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div id="form-group">
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Tone of Voice') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Set result tone of the text as needed') }}"></i></h6>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div id="form-group">
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Number of Results') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Maximum supported results is 5') }}"></i></h6>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Max Result Length') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Maximum words for each generated text result') }}. {{ __('Maximum allowed length is ') }}{{ $limit }}"></i></h6>
								<div class="form-group">							    
		...
		<div class="col-lg-8 col-md-12 col-sm-12">
			<div class="card border-0" id="template-output">
				<div class="card-body">
					<div class="d-flex">
						<div class="w-100">
							<h3 class="card-title fs-16 mt-3 mb-4"><i class="fa-solid fa-scroll mr-4 text-info"></i>{{ __("Generated Result") }}</h3>							
						</div>	
						<div>
						...
						<div>
							<a id="save-button" class="template-button" target="" onclick="return saveText(this);" href="#" data-tippy-content="Save Changes"><i class="fa-solid fa-floppy-disk-pen table-action-buttons delete-action-button"></i></a>
						</div>					
					</div>
						...
						<div class="col-lg-4 col-md-12 col-sm-12">
							<div class="row">
								...
								<div class="col-md-2 col-sm-2" id="add-project-box">
									<div class="dropdown">
										<button class="btn btn-special create-project" type="button" id="add-project" data-tippy-content="{{ __('Create New Workbook') }}"><i class="fa-solid fa-rectangle-history-circle-plus"></i></button>											
									</div>
								</div>
							</div>
						</div>
