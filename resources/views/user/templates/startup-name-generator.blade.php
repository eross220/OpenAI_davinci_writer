...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Startup Name Generator') }}</h4>
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('Startup Name Generator') }}</a></li>
		</ol>
	</div>
			...
			<div class="card border-0" id="template-input">
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						<div class="template-view">
							...
							<div class="template-info">
								<p class="fs-12 text-muted mb-5">{{ __('Generate cool, creative, and catchy names for your startup in seconds') }}</p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Seed words') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('Startup Description') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
