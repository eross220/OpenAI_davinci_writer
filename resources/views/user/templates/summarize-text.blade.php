...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Summarize Text') }}</h4>
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('Summarize Text') }}</a></li>
		</ol>
	</div>
			...
			<div class="card border-0" id="template-input">
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						<div class="template-view">
							...
							<div class="template-info">
								<p class="fs-12 text-muted mb-5">{{ __('Summmarize any text in a short and easy to understand concise way') }}</p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-bold">{{ __('What would you like to summarize?') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
