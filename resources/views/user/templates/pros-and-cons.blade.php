...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Pros & Cons') }}</h4>
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('Pros & Cons') }}</a></li>
		</ol>
	</div>
					...
					<div class="row">
						<div class="template-view">
							...
							<div class="template-info">
								<p class="fs-12 text-muted mb-5">{{ __('Write the pros and cons of a product, service or website') }}</p>
							</div>
						</div>
					</div>
