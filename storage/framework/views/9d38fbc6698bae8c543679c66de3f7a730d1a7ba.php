                            ...
                            <div class="blog" data-aos="zoom-in" data-aos-delay="500" data-aos-once="true" data-aos-duration="1000">			
                                <div class="blog-box">
                                    ...
                                    <div class="blog-info">
                                        ...
                                        <h5 class="blog-title fs-16 text-left mb-3"><?php echo e($blog->title); ?></h5>
                                        <p class="blog-date fs-12 text-muted text-left mb-3"><?php echo e($blog->excerpt()); ?></p>                                        
                                    </div>
                                </div>                        
                            </div> 
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" autocomplete="off" placeholder="First Name" required>
...
unset($__errorArgs, $__bag); ?>" name="lastname" value="<?php echo e(old('lastname')); ?>" autocomplete="off" placeholder="Last Name" required>
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" autocomplete="off"  placeholder="Phone Number" required>
...
unset($__errorArgs, $__bag); ?>" name="message" rows="10" required placeholder="Message"></textarea>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\openaidavinci-1.0\resources\views/home.blade.php ENDPATH**/ ?>