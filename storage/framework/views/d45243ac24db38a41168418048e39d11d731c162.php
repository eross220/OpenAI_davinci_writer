				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card mb-5 border-0">
						<div class="card-header d-inline border-0">
							...
							<?php else: ?>
								<div>
									<h3 class="card-title fs-24 font-weight-800"><?php if($user_subscription->pricing_plan == 'monthly'): ?> <?php echo e(__('Monthly Subscription')); ?> <?php else: ?> <?php echo e(__('Yearly Subscription')); ?> <?php endif; ?></h3>
								</div>
								<div class="mb-1">
						...
						<div class="card-body">
							<div class="mb-3">
								<?php if($user_subscription == ''): ?>
								<span class="fs-12 text-muted"><?php echo e(__('Total one time words available ')); ?> <?php echo e(number_format(auth()->user()->available_words)); ?>.</span> <span class="fs-12 text-muted"><?php echo e(__('Total prepaid words available ')); ?> <?php echo e(number_format(auth()->user()->available_words_prepaid)); ?>. </span>
								<?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\workspace\openaidavinci-1.0\resources\views/user/profile/index.blade.php ENDPATH**/ ?>